...
//   const openCreate = () => {
//     setEditTarget(null);
//     setForm({ ...emptyForm, managerId: user?.id ?? '' });
//     setError('');
//     setShowModal(true);
//   };
...
//       managerId:   project.manager?.id ?? user?.id ?? '',
...
//     if (!window.confirm('Delete this project? All associated tasks will also be deleted.')) return;
//     try {
...
//               className="pl-8 pr-3 py-2 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 w-48"
//             />
//           </div>
//           {isAdminOrManager && (
//             <button
...
//           </svg>
//           <p className="mt-2 text-sm">{search ? 'No projects match your search.' : 'No projects yet.'}</p>
//         </div>
//       ) : (
...
//                   placeholder="e.g. Employee Portal v2"
//                 />
//               </div>
...
//                   Manager ID <span className="text-gray-400">(defaults to you: {user?.id})</span>
//                 </label>
//                 <input
//                   type="number"
...
//                 type="submit"
//                 disabled={submitting}
//                 className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white font-medium py-2.5 rounded-xl text-sm mt-1 transition-colors"
//               >
//                 {submitting
